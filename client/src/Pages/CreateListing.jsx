...
export default function CreateListing() {
  return (
    ...
    <p>Bath</p>
        ...
        <div className='flex items-center gap-2'>
    <input type='number' id='regularprice' min='0' max='10' required
    className='p-3 border border-grey-300 rounded-lg'/>
    ...
    <span className='text=xs'>($ / month) </span>
      ...
      <div className='flex flex-col flex-1'>
          ...
          <div className='flex gap-4'>
            <input  className='p-3 border border-grey-300 rounded'type='file' id='images' accept='image/* multiple '/>
          ...
          <buttonc className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80 mt-7'>Create Listing</buttonc>
      </div>
